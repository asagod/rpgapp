                ...
                <div class="card z-depth-0 bordered">
                    ...
                    <div id="collapseIdade" class="collapse" aria-labelledby="headingIdade" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <p class="d-flex justify-content-center my-4">Você possui&nbsp;
                                <span id="valoridade" style="display:inline-block;"></span>&nbsp;anos de idade!</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card z-depth-0 bordered">
                ...
                <div id="collapseAltura" class="collapse" aria-labelledby="headingAltura" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <p class="d-flex justify-content-center my-4">Você possui&nbsp;
                            <span id="valoraltura" style="display:inline-block;"></span>cm de altura!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card z-depth-0 bordered">
                ...
                <div id="collapsePeso" class="collapse" aria-labelledby="headingPeso" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <p class="d-flex justify-content-center my-4">Você possui&nbsp;
                            <span id="valorpeso" style="display:inline-block;"></span>kg de peso!</p>
                    </div>
                </div>
            </div>
